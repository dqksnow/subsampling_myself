#' The IBOSS method
#'
#' This function implements the IBOSS method for the input covariate Z and
#' response vector Y. It returns a list with elements: beta, the least squares
#' estimate based on the subdata; se, the standard errors; sigma, variance
#' estimate for the error term, index, index of the subdata.
#' @useDynLib IBOSS
